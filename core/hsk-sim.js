    ...
    return {
      ...
      reading: {
        ...
        part3: {
          ...
          example: { num: 'EJ', hanzi: '你喝水吗？', pinyin: 'Nǐ hē shuǐ ma?', answer: 'F' },
          questions: [
            { num: 31, hanzi: '这些东西多少钱？',   pinyin: 'Zhèxiē dōngxī duōshǎo qián?',  answer: 'A' },
            { num: 32, hanzi: '你爸爸在哪儿工作？', pinyin: "Nǐ bàba zài nǎ'er gōngzuò?",   answer: 'E' },
            { num: 33, hanzi: '小月怎么了？',       pinyin: 'Xiǎo Yuè zěnme le?',           answer: 'B' },
            { num: 34, hanzi: '明天天气怎么样？',   pinyin: 'Míngtiān tiānqì zěnmeyàng?',   answer: 'D' },
            { num: 35, hanzi: '今天谁做饭？',       pinyin: 'Jīntiān shéi zuò fàn?',        answer: 'C' },
          ],
        },
        part4: {
          title: 'Parte 8 (Lectura 4) · Completa la oración',
          ...
          example: { num: 'EJ', hanzi: '你叫什么 ( )？', pinyin: 'Nǐ jiào shénme ( )?', answer: 'D' },
          questions: [
            { num: 36, hanzi: '我听说王医生很（ ）',     pinyin: 'Wǒ tīngshuō Wáng yīshēng hěn ( )',  answer: 'F' },
            { num: 37, hanzi: '同学们都喜欢（ ）水果',   pinyin: 'Tóngxuémen dōu xǐhuān ( ) shuǐguǒ',  answer: 'A' },
            { num: 38, hanzi: '他想下个星期去买（ ）',   pinyin: 'Tā xiǎng xià gè xīngqí qù mǎi ( )',  answer: 'C' },
            { num: 39, hanzi: '他们什么（ ）去商店？',   pinyin: 'Tāmen shénme ( ) qù shāngdiàn?',     answer: 'E' },
            { num: 40, hanzi: '钱小姐，你的电话。好的，（ ）', pinyin: 'Qián xiǎojiě, nǐ de diànhuà. Hǎo de, ( )', answer: 'B' },
          ],
        },
      },
    };
    ...
    return {
      ...
      reading: {
        ...
        part3: {
          ...
          example: { num: 'EJ', hanzi: '你喝水吗？', pinyin: 'Nǐ hē shuǐ ma?', answer: 'F' },
          questions: [
            { num: 31, hanzi: '前面那个人是谁？',       pinyin: 'Qiánmiàn nàge rén shì shéi?',        answer: 'C' },
            { num: 32, hanzi: '你昨天上午去学校了吗？', pinyin: 'Nǐ zuótiān shàngwǔ qù xuéxiào le ma?', answer: 'B' },
            { num: 33, hanzi: '这个电影是60分钟吗？',   pinyin: 'Zhège diànyǐng shì 60 fēnzhōng ma?',  answer: 'A' },
            { num: 34, hanzi: '你儿子今年多大？',       pinyin: 'Nǐ érzi jīnnián duō dà?',             answer: 'D' },
            { num: 35, hanzi: '你哪天回国？',           pinyin: 'Nǐ nǎ tiān huí guó?',                 answer: 'E' },
          ],
        },
        part4: {
          title: 'Parte 8 (Lectura 4) · Completa la oración',
          ...
          example: { num: 'EJ', hanzi: '你叫什么 ( )？', pinyin: 'Nǐ jiào shénme ( )?', answer: 'D' },
          questions: [
            { num: 36, hanzi: '她的衣服（ ）小了',                 pinyin: 'Tā de yīfú ( ) xiǎo le',                       answer: 'A' },
            { num: 37, hanzi: '昨天我买了一（ ）汉语书',           pinyin: 'Zuótiān wǒ mǎi le yī ( ) hànyǔ shū',           answer: 'C' },
            { num: 38, hanzi: '我在北京住了5年，我很（ ）这里',     pinyin: 'Wǒ zài Běijīng zhù le 5 nián, wǒ hěn ( ) zhèlǐ', answer: 'E' },
            { num: 39, hanzi: '妈妈这个月（ ）回来',               pinyin: 'Māmā zhège yuè ( ) huílái',                    answer: 'F' },
            { num: 40, hanzi: '你好，你是做什么（ ）的？',         pinyin: 'Nǐ hǎo, nǐ shì zuò shénme ( ) de?',            answer: 'B' },
          ],
        },
      },
    };
    ...
    return {
      ...
      reading: {
        ...
        part3: {
          ...
          example: { num: 'EJ', hanzi: '你喝水吗？', pinyin: 'Nǐ hē shuǐ ma?', answer: 'F' },
          questions: [
            { num: 31, hanzi: '你中午怎么没回家呢？', pinyin: 'Nǐ zhōngwǔ zěnme méi huí jiā ne?', answer: 'A' },
            { num: 32, hanzi: '小王哪天去学车？',     pinyin: 'Xiǎo Wáng nǎ tiān qù xué chē?',    answer: 'D' },
            { num: 33, hanzi: '前面那几个人是谁？',   pinyin: 'Qiánmiàn nà jǐ gè rén shì shéi?',  answer: 'C' },
            { num: 34, hanzi: '小月会说汉语？',       pinyin: 'Xiǎo Yuè huì shuō Hànyǔ?',         answer: 'B' },
            { num: 35, hanzi: '你的儿子多大？',       pinyin: 'Nǐ de érzi duō dà?',               answer: 'E' },
          ],
        },
        part4: {
          title: 'Parte 8 (Lectura 4) · Completa el espacio',
          ...
          example: { num: 'EJ', hanzi: '你叫什么（ ）？', pinyin: 'Nǐ jiào shénme ( )?', answer: 'D' },
          questions: [
            { num: 36, hanzi: '你来看我，我很（ ）。',               pinyin: 'Nǐ lái kàn wǒ, wǒ hěn ( )',                       answer: 'B' },
            { num: 37, hanzi: '（ ），你说什么？我没听见。',         pinyin: '( ), nǐ shuō shénme? Wǒ méi tīngjiàn',            answer: 'A' },
            { num: 38, hanzi: '我不喜欢这个书店，书太（ ）了。',     pinyin: 'Wǒ bù xǐhuān zhège shūdiàn, shū tài ( ) le',      answer: 'F' },
            { num: 39, hanzi: '你什么（ ）回中国？明年，你呢？',     pinyin: 'Nǐ shénme ( ) huí Zhōngguó? Míngnián, nǐ ne?',    answer: 'E' },
            { num: 40, hanzi: '他在哪儿（ ）？在北京大学后面。',     pinyin: "Tā zài nǎ'er ( )? Zài Běijīng dàxué hòumiàn",     answer: 'C' },
          ],
        },
      },
    };
