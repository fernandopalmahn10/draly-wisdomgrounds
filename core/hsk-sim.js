...
const SIMULATIONS = {
  'hsk1-sim1': {
    ...
    reading: {
      ...
      part3: {
        ...
        questions: [
          { num: 31, hanzi: '这个衣服怎么样？',   pinyin: 'Zhège yīfú zěnmeyàng?',   answer: 'E', es: '¿Qué tal esta ropa? → (es muy pequeña)', en: 'How is this outfit? → (it is very small)' },
          { num: 32, hanzi: '那些苹果是谁买的？', pinyin: 'Nàxiē píngguǒ shì shéi mǎi de?', answer: 'A', es: '¿Quién compró esas manzanas? → (mi mamá)', en: 'Who bought those apples? → (my mom)' },
          { num: 33, hanzi: '你哪天回家？',       pinyin: 'Nǐ nǎ tiān huí jiā?',     answer: 'D', es: '¿Qué día vuelves a casa? → (el sábado)', en: 'What day are you going back home? → (Saturday)' },
          { num: 34, hanzi: '你女儿住哪儿？',     pinyin: "Nǐ nǚ'ér zhù nǎ'er?",     answer: 'B', es: '¿Dónde vive tu hija? → (en la escuela)', en: 'Where does your daughter live? → (at school)' },
          { num: 35, hanzi: '他儿子工作了吗？',   pinyin: 'Tā érzi gōngzuò le ma?',  answer: 'C', es: '¿Su hijo ya trabaja? → (no)', en: 'Does his son work already? → (no)' },
        ],
      },
      part4: {
        ...
        questions: [
          { num: 36, hanzi: '那个人是我的（ ）',       pinyin: 'Nàge rén shì wǒ de ( )',       answer: 'B', es: 'Esa persona es mi (alumno).', en: 'That person is my (student).' },
          { num: 37, hanzi: '桌子上有（ ）茶',         pinyin: 'Zhuōzi shàng yǒu ( ) chá',     answer: 'F', es: 'Sobre la mesa hay una (taza) de té.', en: 'On the table there is a (cup) of tea.' },
          { num: 38, hanzi: '再见，（ ）学校见',       pinyin: 'Zàijiàn, ( ) xuéxiào jiàn',    answer: 'E', es: 'Adiós, nos vemos (mañana) en la escuela.', en: 'Goodbye, see you (tomorrow) at school.' },
          { num: 39, hanzi: '小朋友，你（ ）岁了？',   pinyin: 'Xiǎopéngyǒu, nǐ ( ) suì le?',  answer: 'C', es: 'Niño, ¿(cuántos) años tienes?', en: 'Kid, (how many) years old are you?' },
          { num: 40, hanzi: '谢谢你，我（ ）写这个字了', pinyin: 'Xièxiè nǐ, wǒ ( ) xiě zhège zì le', answer: 'A', es: 'Gracias, ya (sé) escribir este carácter.', en: 'Thank you, now I (can) write this character.' },
        ],
      },
    },
  },
    ...
    return {
      ...
      reading: {
        ...
        part3: {
          ...
          example: { num: 'EJ', hanzi: '你喝水吗？', pinyin: 'Nǐ hē shuǐ ma?', answer: 'F' },
          questions: [
            { num: 31, hanzi: '中午想吃什么？',     pinyin: 'Zhōngwǔ xiǎng chī shénme?',  answer: 'D', es: '¿Qué quieres comer al mediodía? → (arroz)', en: 'What do you want to eat at noon? → (rice)' },
            { num: 32, hanzi: '李先生在哪儿工作？', pinyin: "Lǐ xiānsheng zài nǎ'er gōngzuò?", answer: 'B', es: '¿Dónde trabaja el Sr. Li? → (en la librería)', en: 'Where does Mr. Li work? → (at the bookstore)' },
            { num: 33, hanzi: '电影是几点的？',     pinyin: 'Diànyǐng shì jǐ diǎn de?',   answer: 'C', es: '¿A qué hora es la película? → (8:40 de la mañana)', en: 'What time is the movie? → (8:40 in the morning)' },
            { num: 34, hanzi: '谢小姐怎么了？',     pinyin: 'Xiè xiǎojiě zěnme le?',      answer: 'A', es: '¿Qué le pasa a la Srta. Xie? → (extraña su casa)', en: 'What is wrong with Miss Xie? → (she misses home)' },
            { num: 35, hanzi: '这个字，谁会读？',   pinyin: 'Zhège zì, shéi huì dú?',     answer: 'E', es: '¿Quién sabe leer este carácter? → (yo)', en: 'Who can read this character? → (me)' },
          ],
        },
        part4: {
          ...
          example: { num: 'EJ', hanzi: '你叫什么 ( )？', pinyin: 'Nǐ jiào shénme ( )?', answer: 'D' },
          questions: [
            { num: 36, hanzi: '他今年27（ ），是个老师',     pinyin: 'Tā jīnnián 27 ( ), shì gè lǎoshī',         answer: 'B', es: 'Este año tiene 27 (años), es maestro.', en: 'He is 27 (years old) this year; he is a teacher.' },
            { num: 37, hanzi: '昨天的这个时候我在飞机（ ）', pinyin: 'Zuótiān de zhège shíhòu wǒ zài fēijī ( )', answer: 'E', es: 'Ayer a esta hora yo estaba (en) el avión.', en: 'At this time yesterday I was (on) the plane.' },
            { num: 38, hanzi: '现在22点了，我想去（ ）',     pinyin: 'Xiànzài 22 diǎn le, wǒ xiǎng qù ( )',      answer: 'A', es: 'Ya son las 22h, quiero ir a (dormir).', en: 'It is already 22:00; I want to go to (sleep).' },
            { num: 39, hanzi: '谢谢你（ ）我吃饭。不客气',   pinyin: 'Xièxie nǐ ( ) wǒ chī fàn. Bú kèqì',        answer: 'F', es: 'Gracias por (invitarme) a comer. — De nada.', en: 'Thank you for (inviting) me to eat. — You are welcome.' },
            { num: 40, hanzi: '这个桌子太（ ）了。这个呢？', pinyin: 'Zhège zhuōzi tài ( ) le. Zhège ne?',       answer: 'C', es: 'Esta mesa es muy (pequeña). ¿Y esta?', en: 'This table is too (small). What about this one?' },
          ],
        },
      },
    };
    ...
    return {
      ...
      reading: {
        ...
        part3: {
          ...
          example: { num: 'EJ', hanzi: '你喝水吗？', pinyin: 'Nǐ hē shuǐ ma?', answer: 'F' },
          questions: [
            { num: 31, hanzi: '你女儿住哪儿？',     pinyin: "Nǐ nǚ'ér zhù nǎ'er?",       answer: 'A', es: '¿Dónde vive tu hija? → (en la escuela)', en: 'Where does your daughter live? → (at school)' },
            { num: 32, hanzi: '昨天天气怎么样？',   pinyin: 'Zuótiān tiānqì zěnmeyàng?', answer: 'B', es: '¿Qué tiempo hizo ayer? → (mucho calor)', en: 'How was the weather yesterday? → (very hot)' },
            { num: 33, hanzi: '你儿子今年多大？',   pinyin: 'Nǐ érzi jīnnián duō dà?',   answer: 'E', es: '¿Cuántos años tiene tu hijo? → (8 años)', en: 'How old is your son this year? → (8 years old)' },
            { num: 34, hanzi: '明天你怎么去饭店？', pinyin: 'Míngtiān nǐ zěnme qù fàndiàn?', answer: 'D', es: '¿Cómo irás mañana al restaurante? → (en taxi)', en: 'How will you go to the restaurant tomorrow? → (by taxi)' },
            { num: 35, hanzi: '中午想吃什么？',     pinyin: 'Zhōngwǔ xiǎng chī shénme?', answer: 'C', es: '¿Qué quieres comer al mediodía? → (arroz)', en: 'What do you want to eat at noon? → (rice)' },
          ],
        },
        part4: {
          title: 'Parte 8 (Lectura 4) · Completa la oración',
          ...
          example: { num: 'EJ', hanzi: '你叫什么 ( )？', pinyin: 'Nǐ jiào shénme ( )?', answer: 'D' },
          questions: [
            { num: 36, hanzi: '他很（ ）读书，一年读了几十本',     pinyin: 'Tā hěn ( ) dúshū, yī nián dú le jǐshí běn',    answer: 'A', es: 'Le (encanta) leer; leyó decenas de libros en un año.', en: 'He (loves) reading; he read dozens of books in one year.' },
            { num: 37, hanzi: '能请你坐那儿吗？这儿（ ）人',       pinyin: "Néng qǐng nǐ zuò nà'er ma? Zhè'er ( ) rén",   answer: 'C', es: '¿Puedes sentarte allá? Aquí (hay) alguien.', en: 'Could you sit over there? There (is) someone here.' },
            { num: 38, hanzi: '王老师想去医院看他的（ ）',         pinyin: 'Wáng lǎoshī xiǎng qù yīyuàn kàn tā de ( )',   answer: 'B', es: 'El maestro Wang quiere ir al hospital a ver a su (alumno).', en: 'Teacher Wang wants to go to the hospital to see his (student).' },
            { num: 39, hanzi: '你做的菜很好！谢谢！（ ）',         pinyin: 'Nǐ zuò de cài hěn hǎo! Xièxie! ( )',          answer: 'E', es: '¡Tu comida está muy buena! ¡Gracias! → (de nada)', en: 'Your cooking is great! Thank you! → (you are welcome)' },
            { num: 40, hanzi: '李先生会（ ）汉语吗？会一点儿',     pinyin: 'Lǐ xiānsheng huì ( ) hànyǔ ma? Huì yìdiǎnr',  answer: 'F', es: '¿El Sr. Li sabe (hablar) chino? — Un poco.', en: 'Can Mr. Li (speak) Chinese? — A little.' },
          ],
        },
      },
    };
    ...
    return {
      ...
      reading: {
        ...
        part3: {
          ...
          example: { num: 'EJ', hanzi: '你喝水吗？', pinyin: 'Nǐ hē shuǐ ma?', answer: 'F' },
          questions: [
            { num: 31, hanzi: '那个小狗是谁的？',     pinyin: 'Nàge xiǎo gǒu shì shéi de?',     answer: 'E', es: '¿De quién es ese perrito? → (de mi amigo)', en: 'Whose puppy is that? → (my friend\'s)' },
            { num: 32, hanzi: '你儿子在哪儿工作？',   pinyin: "Nǐ érzi zài nǎ'er gōngzuò?",     answer: 'A', es: '¿Dónde trabaja tu hijo? → (en China)', en: 'Where does your son work? → (in China)' },
            { num: 33, hanzi: '你在这儿住几天？',     pinyin: "Nǐ zài zhè'er zhù jǐ tiān?",     answer: 'C', es: '¿Cuántos días te quedas aquí? → (un mes)', en: 'How many days are you staying here? → (one month)' },
            { num: 34, hanzi: '他的汉语怎么样？',     pinyin: 'Tā de hànyǔ zěnmeyàng?',         answer: 'B', es: '¿Qué tal su chino? → (muy bueno)', en: 'How is his Chinese? → (very good)' },
            { num: 35, hanzi: '学校后面有商店吗？',   pinyin: 'Xuéxiào hòumiàn yǒu shāngdiàn ma?', answer: 'D', es: '¿Hay tiendas detrás de la escuela? → (sí, bastantes)', en: 'Are there shops behind the school? → (yes, quite a few)' },
          ],
        },
        part4: {
          title: 'Parte 8 (Lectura 4) · Completa la oración',
          ...
          example: { num: 'EJ', hanzi: '你叫什么 ( )？', pinyin: 'Nǐ jiào shénme ( )?', answer: 'D' },
          questions: [
            { num: 36, hanzi: '今天天气很（ ）',               pinyin: 'Jīntiān tiānqì hěn ( )',                       answer: 'B', es: 'Hoy hace mucho (frío).', en: 'Today the weather is very (cold).' },
            { num: 37, hanzi: '我妈妈喜欢吃中国（ ）',         pinyin: 'Wǒ māma xǐhuān chī Zhōngguó ( )',               answer: 'C', es: 'A mi mamá le gusta comer (comida) china.', en: 'My mom likes to eat Chinese (food).' },
            { num: 38, hanzi: '杯子（ ）少了，我们有九个人',   pinyin: 'Bēizi ( ) shǎo le, wǒmen yǒu jiǔ gè rén',      answer: 'A', es: 'Hay (demasiado) pocas tazas; somos nueve personas.', en: 'There are (too) few cups; there are nine of us.' },
            { num: 39, hanzi: '下雨了，你怎么回家？我（ ）车了', pinyin: 'Xià yǔ le, nǐ zěnme huí jiā? Wǒ ( ) chē le',   answer: 'E', es: 'Está lloviendo, ¿cómo vuelves? — (manejé) el auto.', en: 'It is raining, how are you getting home? — I (drove) the car.' },
            { num: 40, hanzi: '明天上午我们去看（ ）怎么样？', pinyin: 'Míngtiān shàngwǔ wǒmen qù kàn ( ) zěnmeyàng?',  answer: 'F', es: 'Mañana en la mañana, ¿qué tal si vamos a ver una (película)?', en: 'How about we go see a (movie) tomorrow morning?' },
          ],
        },
      },
    };
    ...
    return {
      ...
      reading: {
        ...
        part3: {
          ...
          example: { num: 'EJ', hanzi: '你喝水吗？', pinyin: 'Nǐ hē shuǐ ma?', answer: 'F' },
          questions: [
            { num: 31, hanzi: '他现在在哪儿读书？',   pinyin: "Tā xiànzài zài nǎ'er dúshū?",        answer: 'D', es: '¿Dónde estudia él ahora? → (en la Universidad de Pekín)', en: 'Where does he study now? → (at Peking University)' },
            { num: 32, hanzi: '你看见张小姐了吗？',   pinyin: 'Nǐ kànjiàn Zhāng xiǎojiě le ma?',    answer: 'A', es: '¿Viste a la Srta. Zhang? → (no)', en: 'Did you see Miss Zhang? → (no)' },
            { num: 33, hanzi: '你们是什么时候认识的？', pinyin: 'Nǐmen shì shénme shíhòu rènshi de?', answer: 'B', es: '¿Cuándo se conocieron? → (el mes pasado)', en: 'When did you meet? → (last month)' },
            { num: 34, hanzi: '你们谁会开车？',       pinyin: 'Nǐmen shéi huì kāichē?',             answer: 'C', es: '¿Quién de ustedes sabe manejar? → (yo)', en: 'Which of you can drive? → (me)' },
            { num: 35, hanzi: '明天天气怎么样？',     pinyin: 'Míngtiān tiānqì zěnmeyàng?',         answer: 'E', es: '¿Qué tiempo hará mañana? → (lloverá al mediodía)', en: 'What will the weather be like tomorrow? → (it will rain at noon)' },
          ],
        },
        part4: {
          title: 'Parte 8 (Lectura 4) · Completa la oración',
          ...
          example: { num: 'EJ', hanzi: '你叫什么 ( )？', pinyin: 'Nǐ jiào shénme ( )?', answer: 'D' },
          questions: [
            { num: 36, hanzi: '现在有很（ ）人来中国学汉语',    pinyin: 'Xiànzài yǒu hěn ( ) rén lái Zhōngguó xué hànyǔ', answer: 'B', es: 'Ahora (muchas) personas vienen a China a aprender chino.', en: 'Now (many) people come to China to learn Chinese.' },
            { num: 37, hanzi: '（ ）你说什么？我没听见',        pinyin: '( ) nǐ shuō shénme? Wǒ méi tīngjiàn',            answer: 'C', es: '(Perdón), ¿qué dijiste? No te oí.', en: '(Sorry), what did you say? I did not hear you.' },
            { num: 38, hanzi: '再见，（ ）学校见',              pinyin: 'Zàijiàn, ( ) xuéxiào jiàn',                      answer: 'E', es: 'Adiós, nos vemos (mañana) en la escuela.', en: 'Goodbye, see you (tomorrow) at school.' },
            { num: 39, hanzi: '你回来的时候（ ）些水果',        pinyin: 'Nǐ huílái de shíhòu ( ) xiē shuǐguǒ',            answer: 'A', es: 'Cuando vuelvas, (compra) algo de fruta.', en: 'When you come back, (buy) some fruit.' },
            { num: 40, hanzi: '你现在在哪儿？我在（ ），10分钟后回去', pinyin: "Nǐ xiànzài zài nǎ'er? Wǒ zài ( ), 10 fēnzhōng hòu huíqù", answer: 'F', es: '¿Dónde estás? Estoy en la (tienda); vuelvo en 10 min.', en: 'Where are you? I am at the (store); I will be back in 10 min.' },
          ],
        },
      },
    };
    ...
    return {
      ...
      reading: {
        ...
        part3: {
          ...
          example: { num: 'EJ', hanzi: '你喝水吗？', pinyin: 'Nǐ hē shuǐ ma?', answer: 'F' },
          questions: [
            { num: 31, hanzi: '你女儿在家吗？',     pinyin: "Nǐ nǚ'ér zài jiā ma?",          answer: 'A', es: '¿Tu hija está en casa? → (se fue a la escuela)', en: 'Is your daughter at home? → (she went to school)' },
            { num: 32, hanzi: '明天的天气怎么样？', pinyin: 'Míngtiān de tiānqì zěnmeyàng?', answer: 'D', es: '¿Qué tiempo hará mañana? → (hará mucho calor)', en: 'What will the weather be like tomorrow? → (it will be very hot)' },
            { num: 33, hanzi: '你们喜欢吃什么菜？', pinyin: 'Nǐmen xǐhuān chī shénme cài?',  answer: 'E', es: '¿Qué comida les gusta comer? → (comida china)', en: 'What food do you like to eat? → (Chinese food)' },
            { num: 34, hanzi: '你怎么了？',         pinyin: 'Nǐ zěnme le?',                  answer: 'B', es: '¿Qué te pasa? → (tengo sueño)', en: 'What is wrong? → (I am sleepy)' },
            { num: 35, hanzi: '谁说你汉语很好？',   pinyin: 'Shéi shuō nǐ hànyǔ hěn hǎo?',   answer: 'C', es: '¿Quién dice que tu chino es muy bueno? → (mi maestro)', en: 'Who says your Chinese is very good? → (my teacher)' },
          ],
        },
        part4: {
          title: 'Parte 8 (Lectura 4) · Completa la oración',
          ...
          example: { num: 'EJ', hanzi: '你叫什么 ( )？', pinyin: 'Nǐ jiào shénme ( )?', answer: 'D' },
          questions: [
            { num: 36, hanzi: '他（ ）给我说，他不来',         pinyin: 'Tā ( ) gěi wǒ shuō, tā bù lái',          answer: 'F', es: 'Él me (llamó por teléfono) para decir que no viene.', en: 'He (called me on the phone) to say he is not coming.' },
            { num: 37, hanzi: '老师们都很喜欢这个（ ）',       pinyin: 'Lǎoshīmen dōu hěn xǐhuān zhège ( )',     answer: 'E', es: 'A los maestros les gusta mucho este (alumno).', en: 'The teachers all really like this (student).' },
            { num: 38, hanzi: '我学（ ）了做饭',               pinyin: 'Wǒ xué ( ) le zuò fàn',                  answer: 'A', es: 'Ya (sé) cocinar.', en: 'I now (know how) to cook.' },
            { num: 39, hanzi: '这个椅子很（ ）。这是我爸爸买的', pinyin: 'Zhège yǐzi hěn ( ). Zhè shì wǒ bàba mǎi de', answer: 'B', es: 'Esta silla es muy (bonita). La compró mi papá.', en: 'This chair is very (pretty). My dad bought it.' },
            { num: 40, hanzi: '这家商店是什么时候开的？3（ ）7号', pinyin: 'Zhè jiā shāngdiàn shì shénme shíhòu kāi de? 3 ( ) 7 hào', answer: 'C', es: '¿Cuándo abrió esta tienda? — El 7 de (marzo / mes 3).', en: 'When did this store open? — On the 7th of (March / month 3).' },
          ],
        },
      },
    };
    ...
    return {
      ...
      reading: {
        ...
        part3: {
          ...
          example: { num: 'EJ', hanzi: '你喝水吗？', pinyin: 'Nǐ hē shuǐ ma?', answer: 'F' },
          questions: [
            { num: 31, hanzi: '今天星期几？',         pinyin: 'Jīntiān xīngqí jǐ?',               answer: 'A', es: '¿Qué día es hoy? → (lunes)', en: 'What day is it today? → (Monday)' },
            { num: 32, hanzi: '谢谢你请我吃饭',       pinyin: 'Xièxie nǐ qǐng wǒ chīfàn',         answer: 'E', es: 'Gracias por invitarme a comer → (de nada)', en: 'Thank you for inviting me to eat → (you are welcome)' },
            { num: 33, hanzi: '你在北京学什么？',     pinyin: 'Nǐ zài Běijīng xué shénme?',       answer: 'B', es: '¿Qué estudias en Pekín? → (estudio chino)', en: 'What do you study in Beijing? → (I study Chinese)' },
            { num: 34, hanzi: '他是一个人来中国的吗？', pinyin: 'Tā shì yī gè rén lái Zhōngguó de ma?', answer: 'D', es: '¿Vino solo a China? → (sí, vino solo)', en: 'Did he come to China alone? → (yes, he came alone)' },
            { num: 35, hanzi: '你的车在哪儿？',       pinyin: "Nǐ de chē zài nǎ'er?",             answer: 'C', es: '¿Dónde está tu auto? → (detrás del restaurante)', en: 'Where is your car? → (behind the restaurant)' },
          ],
        },
        ...
        part4: {
          ...
          example: { num: 'EJ', hanzi: '你叫什么 ( )？', pinyin: 'Nǐ jiào shénme ( )?', answer: 'D' },
          questions: [
            { num: 36, hanzi: '她买了（ ）米饭',                   pinyin: 'Tā mǎi le ( ) mǐfàn',                          answer: 'F', es: 'Ella compró (un poco) de arroz.', en: 'She bought (a little) rice.' },
            { num: 37, hanzi: '他不认识坐在他前面的（ ）',         pinyin: 'Tā bú rènshi zuò zài tā qiánmiàn de ( )',      answer: 'E', es: 'No conoce al (alumno) sentado delante de él.', en: 'He does not know the (student) sitting in front of him.' },
            { num: 38, hanzi: '这个电影是哪一（ ）的？',           pinyin: 'Zhège diànyǐng shì nǎ yī ( ) de?',             answer: 'C', es: '¿De qué (año) es esta película?', en: 'What (year) is this movie from?' },
            { num: 39, hanzi: '你怎么不认识这个汉字？我（ ）没来', pinyin: 'Nǐ zěnme bú rènshi zhège hànzì? Wǒ ( ) méi lái', answer: 'B', es: '¿Cómo no conoces este carácter? (Ayer) no vine.', en: 'How come you do not know this character? (Yesterday) I did not come.' },
            { num: 40, hanzi: '钱先生（ ）吗？他去医院了',         pinyin: 'Qián xiānsheng ( ) ma? Tā qù yīyuàn le',       answer: 'A', es: '¿(Está) el Sr. Qian? — Se fue al hospital.', en: '(Is) Mr. Qian in? — He went to the hospital.' },
          ],
        },
      },
    };
  ...
  // ═══════════════════════════════════════════════════════════════════════
  // HSK1 · SIMULATION 8 — full 40-question exam (8 parts). Assets uploaded by
  // Fernando 2026-06-21 in /assets/HSK SIMULATIONS/HSK 1/SIMULATION 8/.
  // Answer keys come from the (TRUE/FALSE/CORRECT/letter) filename markers and
  // the per-part QUESTIONS.txt. Same shape as Sim 7.
  // ═══════════════════════════════════════════════════════════════════════
  'hsk1-sim8': (() => {
    const B8 = '/assets/HSK%20SIMULATIONS/HSK%201/SIMULATION%208';
    return {
      id: 'hsk1-sim8',
      title: 'HSK1 · Simulación 8',
      level: 'hsk1',
      totalQuestions: 40,
      pointsPerQuestion: 10,
      listening: {
        part1: {
          ...
          instruction: 'Escucha el audio. ¿Es lo que muestra la imagen? Marca ✓ o ✕.',
          examples: [
            { num: 'EJ1', image: `${B8}/LISTENING%20PART%201/PART%201%20EXAMPLE%201.png`, audioText: '', answer: true,  caption: 'Ejemplo 1' },
            { num: 'EJ2', image: `${B8}/LISTENING%20PART%201/PART%201%20EXAMPLE%202.png`, audioText: '', answer: false, caption: 'Ejemplo 2' },
          ],
          // Sim 8 L1 markers: T F T F T
          questions: [
            { num: 1, image: `${B8}/LISTENING%20PART%201/1%20(TRUE).png`,   audioUrl: `${B8}/LISTENING%20PART%201/1.mp3`, audioText: '', answer: true  },
            { num: 2, image: `${B8}/LISTENING%20PART%201/2%20(FALSE).png`,  audioUrl: `${B8}/LISTENING%20PART%201/2.mp3`, audioText: '', answer: false },
            { num: 3, image: `${B8}/LISTENING%20PART%201/3%20(TRUE).jpeg`,  audioUrl: `${B8}/LISTENING%20PART%201/3.mp3`, audioText: '', answer: true  },
            { num: 4, image: `${B8}/LISTENING%20PART%201/4%20(FALSE).jpeg`, audioUrl: `${B8}/LISTENING%20PART%201/4.mp3`, audioText: '', answer: false },
            { num: 5, image: `${B8}/LISTENING%20PART%201/5%20(TRUE).jpeg`,  audioUrl: `${B8}/LISTENING%20PART%201/5.mp3`, audioText: '', answer: true  },
          ],
        },
        part2: {
          title: 'Parte 2 · Tres imágenes',
          instruction: 'Escucha el audio y toca la imagen correcta.',
          // Sim 8 L2 correct positions: B A C A B
          questions: [
            { num: 6,  audioUrl: `${B8}/LISTENING%20PART%202/6.mp3`,  audioText: '', options: [
                { letter: 'A', image: `${B8}/LISTENING%20PART%202/6A.jpeg` },
                { letter: 'B', image: `${B8}/LISTENING%20PART%202/6B%20(CORRECT).jpeg` },
                { letter: 'C', image: `${B8}/LISTENING%20PART%202/6C.jpeg` },
              ], answer: 'B' },
            { num: 7,  audioUrl: `${B8}/LISTENING%20PART%202/7.mp3`,  audioText: '', options: [
                { letter: 'A', image: `${B8}/LISTENING%20PART%202/7A%20(CORRECT).png` },
                { letter: 'B', image: `${B8}/LISTENING%20PART%202/7B.png` },
                { letter: 'C', image: `${B8}/LISTENING%20PART%202/7C.png` },
              ], answer: 'A' },
            { num: 8,  audioUrl: `${B8}/LISTENING%20PART%202/8.mp3`,  audioText: '', options: [
                { letter: 'A', image: `${B8}/LISTENING%20PART%202/8A.jpeg` },
                { letter: 'B', image: `${B8}/LISTENING%20PART%202/8B.jpeg` },
                { letter: 'C', image: `${B8}/LISTENING%20PART%202/8C%20(CORRECT).png` },
              ], answer: 'C' },
            { num: 9,  audioUrl: `${B8}/LISTENING%20PART%202/9.mp3`,  audioText: '', options: [
                { letter: 'A', image: `${B8}/LISTENING%20PART%202/9A%20(CORRECT).png` },
                { letter: 'B', image: `${B8}/LISTENING%20PART%202/9B.png` },
                { letter: 'C', image: `${B8}/LISTENING%20PART%202/9C.png` },
              ], answer: 'A' },
            { num: 10, audioUrl: `${B8}/LISTENING%20PART%202/10.mp3`, audioText: '', options: [
                { letter: 'A', image: `${B8}/LISTENING%20PART%202/10A.png` },
                { letter: 'B', image: `${B8}/LISTENING%20PART%202/10B%20(CORRECT).png` },
                { letter: 'C', image: `${B8}/LISTENING%20PART%202/10C.png` },
              ], answer: 'B' },
          ],
        },
        part3: {
          title: 'Parte 3 · Empareja con la imagen',
          instruction: 'Escucha cada audio y toca la letra de la imagen correcta.',
          // Sim 8 file convention "N (LETTER)": 11→F 12→E 13→B 14→D 15→A · C example
          gallery: [
            { letter: 'A', image: `${B8}/LISTENING%20PART%203/15%20(A).png`,     label: 'A' },
            { letter: 'B', image: `${B8}/LISTENING%20PART%203/13%20(B).jpeg`,    label: 'B' },
            { letter: 'C', image: `${B8}/LISTENING%20PART%203/C%20(EXAMPLE).png`, label: 'C (ejemplo)' },
            { letter: 'D', image: `${B8}/LISTENING%20PART%203/14%20(D).jpeg`,    label: 'D' },
            { letter: 'E', image: `${B8}/LISTENING%20PART%203/12%20(E).png`,     label: 'E' },
            { letter: 'F', image: `${B8}/LISTENING%20PART%203/11%20(F).jpeg`,    label: 'F' },
          ],
          exampleAnswer: 'C',
          questions: [
            { num: 11, audioUrl: `${B8}/LISTENING%20PART%203/11.mp3`, audioText: '', answer: 'F' },
            { num: 12, audioUrl: `${B8}/LISTENING%20PART%203/12.mp3`, audioText: '', answer: 'E' },
            { num: 13, audioUrl: `${B8}/LISTENING%20PART%203/13.mp3`, audioText: '', answer: 'B' },
            { num: 14, audioUrl: `${B8}/LISTENING%20PART%203/14.mp3`, audioText: '', answer: 'D' },
            { num: 15, audioUrl: `${B8}/LISTENING%20PART%203/15.mp3`, audioText: '', answer: 'A' },
          ],
        },
        part4: {
          title: 'Parte 4 · Tres opciones',
          ...
          // Sim 8 L4 from .bmp option filenames:
          //   16: A fàndiàn hòumiàn / B shūdiàn hòumiàn / C xuéxiào hòumiàn (✓)
          //   17: A 6 diǎn 30 fēn (✓) / B 6 diǎn 40 fēn / C 6 diǎn 50 fēn
          //   18: A zuò fàn / B xiě Hànzì (✓) / C shuō Hànyǔ
          //   19: A kàn shū / B kàn diànyǐng / C kàn diànshì (✓)
          //   20: A xuéshēng / B yīshēng (✓) / C lǎoshī
          questions: [
            { num: 16, audioUrl: `${B8}/LISTENING%20PART%204/16/16.mp3`, audioText: '', options: [
                { letter: 'A', text: 'fàndiàn hòumiàn' },
                { letter: 'B', text: 'shūdiàn hòumiàn' },
                { letter: 'C', text: 'xuéxiào hòumiàn' },
              ], answer: 'C' },
            { num: 17, audioUrl: `${B8}/LISTENING%20PART%204/17/17.mp3`, audioText: '', options: [
                { letter: 'A', text: '6 diǎn 30 fēn' },
                { letter: 'B', text: '6 diǎn 40 fēn' },
                { letter: 'C', text: '6 diǎn 50 fēn' },
              ], answer: 'A' },
            { num: 18, audioUrl: `${B8}/LISTENING%20PART%204/18/18.mp3`, audioText: '', options: [
                { letter: 'A', text: 'zuò fàn' },
                { letter: 'B', text: 'xiě Hànzì' },
                { letter: 'C', text: 'shuō Hànyǔ' },
              ], answer: 'B' },
            { num: 19, audioUrl: `${B8}/LISTENING%20PART%204/19/19.mp3`, audioText: '', options: [
                { letter: 'A', text: 'kàn shū' },
                { letter: 'B', text: 'kàn diànyǐng' },
                { letter: 'C', text: 'kàn diànshì' },
              ], answer: 'C' },
            { num: 20, audioUrl: `${B8}/LISTENING%20PART%204/20/20.mp3`, audioText: '', options: [
                { letter: 'A', text: 'xuéshēng' },
                { letter: 'B', text: 'yīshēng' },
                { letter: 'C', text: 'lǎoshī' },
              ], answer: 'B' },
          ],
        },
      },
      reading: {
        part1: {
          title: 'Parte 5 (Lectura 1) · Verdadero / Falso',
          instruction: 'Lee la palabra. ¿Coincide con la imagen? Marca ✓ o ✕.',
          example: { num: 'EJ', word: 'diànshì', image: `${B8}/READING%20PART%201/EXAMPLE%20(FALSE).png`, answer: false },
          // Sim 8 R1 words (QUESTIONS.txt) + markers T F T F T
          questions: [
            { num: 21, word: 'bēizi',         image: `${B8}/READING%20PART%201/21%20(TRUE).png`,   answer: true  },
            { num: 22, word: 'gōngzuò',       image: `${B8}/READING%20PART%201/22%20(FALSE).png`,  answer: false },
            { num: 23, word: 'xiānsheng',     image: `${B8}/READING%20PART%201/23%20(TRUE).jpeg`,  answer: true  },
            { num: 24, word: 'diànyǐngyuàn',  image: `${B8}/READING%20PART%201/24%20(FALSE).jpeg`, answer: false },
            { num: 25, word: 'gāoxìng',       image: `${B8}/READING%20PART%201/25%20(TRUE).jpeg`,  answer: true  },
          ],
        },
        part2: {
          title: 'Parte 6 (Lectura 2) · Empareja con la imagen',
          instruction: 'Lee cada oración y toca la letra de la imagen que la representa.',
          // Sim 8 R2 picture-letter map: 26→C 27→F 28→B 29→D 30→A · E example
          gallery: [
            { letter: 'A', image: `${B8}/READING%20PART%202/30%20(A).png`,     label: 'A' },
            { letter: 'B', image: `${B8}/READING%20PART%202/28%20(B).png`,     label: 'B' },
            { letter: 'C', image: `${B8}/READING%20PART%202/26%20(C).png`,     label: 'C' },
            { letter: 'D', image: `${B8}/READING%20PART%202/29%20(D).png`,     label: 'D' },
            { letter: 'E', image: `${B8}/READING%20PART%202/E%20(EXAMPLE).png`, label: 'E (ejemplo)' },
            { letter: 'F', image: `${B8}/READING%20PART%202/27%20(F).png`,     label: 'F' },
          ],
          example: { num: 'EJ', hanzi: '我很喜欢这本书', pinyin: 'Wǒ hěn xǐhuān zhè běn shū', answer: 'E' },
          questions: [
            { num: 26, hanzi: '昨天是12月31号',     pinyin: 'Zuótiān shì 12 yuè 31 hào',      answer: 'C' },
            { num: 27, hanzi: '这个菜是他做的',     pinyin: 'Zhège cài shì tā zuò de',        answer: 'F' },
            { num: 28, hanzi: '我们坐飞机去北京',   pinyin: 'Wǒmen zuò fēijī qù Běijīng',     answer: 'B' },
            { num: 29, hanzi: '他住院了',           pinyin: 'Tā zhùyuàn le',                  answer: 'D' },
            { num: 30, hanzi: '他们两个是好朋友',   pinyin: 'Tāmen liǎng gè shì hǎo péngyǒu', answer: 'A' },
          ],
        },
        part3: {
          title: 'Parte 7 (Lectura 3) · Pregunta ↔ Respuesta',
          instruction: 'Lee cada pregunta y elige la mejor respuesta del banco A-F.',
          bank: [
            { letter: 'A', hanzi: '20块',     pinyin: '20 kuài' },
            { letter: 'B', hanzi: '想睡觉了', pinyin: 'xiǎng shuìjiào le' },
            { letter: 'C', hanzi: '妈妈',     pinyin: 'māma' },
            { letter: 'D', hanzi: '会很冷',   pinyin: 'huì hěn lěng' },
            { letter: 'E', hanzi: '北京大学', pinyin: 'Běijīng dàxué' },
            { letter: 'F', hanzi: '好的，谢谢！', pinyin: 'hǎo de, xièxie!' },
          ],
          example: { num: 'EJ', hanzi: '你喝水吗？', pinyin: 'Nǐ hē shuǐ ma?', answer: 'F' },
          questions: [
            { num: 31, hanzi: '这些东西多少钱？',   pinyin: 'Zhèxiē dōngxī duōshǎo qián?',  answer: 'A', es: '¿Cuánto cuestan estas cosas? → (20 yuanes)', en: 'How much do these things cost? → (20 yuan)' },
            { num: 32, hanzi: '你爸爸在哪儿工作？', pinyin: "Nǐ bàba zài nǎ'er gōngzuò?",   answer: 'E', es: '¿Dónde trabaja tu papá? → (en la Universidad de Pekín)', en: 'Where does your dad work? → (at Peking University)' },
            { num: 33, hanzi: '小月怎么了？',       pinyin: 'Xiǎo Yuè zěnme le?',           answer: 'B', es: '¿Qué le pasa a Xiao Yue? → (tiene sueño)', en: 'What is wrong with Xiao Yue? → (she is sleepy)' },
            { num: 34, hanzi: '明天天气怎么样？',   pinyin: 'Míngtiān tiānqì zěnmeyàng?',   answer: 'D', es: '¿Qué tiempo hará mañana? → (hará mucho frío)', en: 'What will the weather be like tomorrow? → (it will be very cold)' },
            { num: 35, hanzi: '今天谁做饭？',       pinyin: 'Jīntiān shéi zuò fàn?',        answer: 'C', es: '¿Quién cocina hoy? → (mamá)', en: 'Who is cooking today? → (mom)' },
          ],
        },
        part4: {
          title: 'Parte 8 (Lectura 4) · Completa la oración',
          instruction: 'Lee cada oración y elige la palabra del banco A-F que completa el ( ).',
          bank: [
            { letter: 'A', hanzi: '吃',   pinyin: 'chī' },
            { letter: 'B', hanzi: '谢谢', pinyin: 'xièxie' },
            { letter: 'C', hanzi: '电脑', pinyin: 'diànnǎo' },
            { letter: 'D', hanzi: '名字', pinyin: 'míngzi' },
            { letter: 'E', hanzi: '时候', pinyin: 'shíhou' },
            { letter: 'F', hanzi: '漂亮', pinyin: 'piàoliang' },
          ],
          example: { num: 'EJ', hanzi: '你叫什么 ( )？', pinyin: 'Nǐ jiào shénme ( )?', answer: 'D' },
          questions: [
            { num: 36, hanzi: '我听说王医生很（ ）',     pinyin: 'Wǒ tīngshuō Wáng yīshēng hěn ( )',  answer: 'F', es: 'Oí que la doctora Wang es muy (bonita).', en: 'I heard Doctor Wang is very (pretty).' },
            { num: 37, hanzi: '同学们都喜欢（ ）水果',   pinyin: 'Tóngxuémen dōu xǐhuān ( ) shuǐguǒ',  answer: 'A', es: 'A los compañeros les gusta (comer) fruta.', en: 'The classmates all like to (eat) fruit.' },
            { num: 38, hanzi: '他想下个星期去买（ ）',   pinyin: 'Tā xiǎng xià gè xīngqí qù mǎi ( )',  answer: 'C', es: 'La próxima semana quiere ir a comprar una (computadora).', en: 'Next week he wants to go buy a (computer).' },
            { num: 39, hanzi: '他们什么（ ）去商店？',   pinyin: 'Tāmen shénme ( ) qù shāngdiàn?',     answer: 'E', es: '¿(Cuándo) van a la tienda?', en: '(When) are they going to the store?' },
            { num: 40, hanzi: '钱小姐，你的电话。好的，（ ）', pinyin: 'Qián xiǎojiě, nǐ de diànhuà. Hǎo de, ( )', answer: 'B', es: 'Srta. Qian, su llamada. — Bien, (gracias).', en: 'Miss Qian, your phone call. — OK, (thanks).' },
          ],
        },
      },
    };
  ...
  // ═══════════════════════════════════════════════════════════════════════
  // HSK1 · SIMULATION 9 — full 40-question exam (8 parts). Assets uploaded by
  // Fernando 2026-06-21 in /assets/HSK SIMULATIONS/HSK 1/SIMULATION 9/.
  // Answer keys from (TRUE/FALSE/CORRECT/letter) filename markers + QUESTIONS.txt.
  // ═══════════════════════════════════════════════════════════════════════
  'hsk1-sim9': (() => {
    const B9 = '/assets/HSK%20SIMULATIONS/HSK%201/SIMULATION%209';
    return {
      id: 'hsk1-sim9',
      title: 'HSK1 · Simulación 9',
      level: 'hsk1',
      totalQuestions: 40,
      pointsPerQuestion: 10,
      listening: {
        part1: {
          ...
          instruction: 'Escucha el audio. ¿Es lo que muestra la imagen? Marca ✓ o ✕.',
          examples: [
            { num: 'EJ1', image: `${B9}/LISTENING%20PART%201/PART%201%20EXAMPLE%201.png`, audioText: '', answer: true,  caption: 'Ejemplo 1' },
            { num: 'EJ2', image: `${B9}/LISTENING%20PART%201/PART%201%20EXAMPLE%202.png`, audioText: '', answer: false, caption: 'Ejemplo 2' },
          ],
          // Sim 9 L1 markers: F T F T F
          questions: [
            { num: 1, image: `${B9}/LISTENING%20PART%201/1%20(FALSE).png`, audioUrl: `${B9}/LISTENING%20PART%201/1.mp3`, audioText: '', answer: false },
            { num: 2, image: `${B9}/LISTENING%20PART%201/2%20(TRUE).png`,  audioUrl: `${B9}/LISTENING%20PART%201/2.mp3`, audioText: '', answer: true  },
            { num: 3, image: `${B9}/LISTENING%20PART%201/3%20(FALSE).png`, audioUrl: `${B9}/LISTENING%20PART%201/3.mp3`, audioText: '', answer: false },
            { num: 4, image: `${B9}/LISTENING%20PART%201/4%20(TRUE).png`,  audioUrl: `${B9}/LISTENING%20PART%201/4.mp3`, audioText: '', answer: true  },
            { num: 5, image: `${B9}/LISTENING%20PART%201/5%20(FALSE).png`, audioUrl: `${B9}/LISTENING%20PART%201/5.mp3`, audioText: '', answer: false },
          ],
        },
        part2: {
          title: 'Parte 2 · Tres imágenes',
          instruction: 'Escucha el audio y toca la imagen correcta.',
          // Sim 9 L2 correct positions: A C B A B
          questions: [
            { num: 6,  audioUrl: `${B9}/LISTENING%20PART%202/6.mp3`,  audioText: '', options: [
                { letter: 'A', image: `${B9}/LISTENING%20PART%202/6A%20(CORRECT).png` },
                { letter: 'B', image: `${B9}/LISTENING%20PART%202/6B.png` },
                { letter: 'C', image: `${B9}/LISTENING%20PART%202/6C.png` },
              ], answer: 'A' },
            { num: 7,  audioUrl: `${B9}/LISTENING%20PART%202/7.mp3`,  audioText: '', options: [
                { letter: 'A', image: `${B9}/LISTENING%20PART%202/7A.jpeg` },
                { letter: 'B', image: `${B9}/LISTENING%20PART%202/7B.png` },
                { letter: 'C', image: `${B9}/LISTENING%20PART%202/7C%20(CORRECT).jpeg` },
              ], answer: 'C' },
            { num: 8,  audioUrl: `${B9}/LISTENING%20PART%202/8.mp3`,  audioText: '', options: [
                { letter: 'A', image: `${B9}/LISTENING%20PART%202/8A.jpeg` },
                { letter: 'B', image: `${B9}/LISTENING%20PART%202/8B%20(CORRECT).jpeg` },
                { letter: 'C', image: `${B9}/LISTENING%20PART%202/8C.jpeg` },
              ], answer: 'B' },
            { num: 9,  audioUrl: `${B9}/LISTENING%20PART%202/9.mp3`,  audioText: '', options: [
                { letter: 'A', image: `${B9}/LISTENING%20PART%202/9A%20(CORRECT).jpeg` },
                { letter: 'B', image: `${B9}/LISTENING%20PART%202/9B.png` },
                { letter: 'C', image: `${B9}/LISTENING%20PART%202/9C.jpeg` },
              ], answer: 'A' },
            { num: 10, audioUrl: `${B9}/LISTENING%20PART%202/10.mp3`, audioText: '', options: [
                { letter: 'A', image: `${B9}/LISTENING%20PART%202/10A.png` },
                { letter: 'B', image: `${B9}/LISTENING%20PART%202/10B%20(CORRECT).jpeg` },
                { letter: 'C', image: `${B9}/LISTENING%20PART%202/10C.jpeg` },
              ], answer: 'B' },
          ],
        },
        part3: {
          title: 'Parte 3 · Empareja con la imagen',
          instruction: 'Escucha cada audio y toca la letra de la imagen correcta.',
          // Sim 9 "N (LETTER)": 11→B 12→F 13→A 14→E 15→D · C example
          gallery: [
            { letter: 'A', image: `${B9}/LISTENING%20PART%203/13%20(A).jpeg`,    label: 'A' },
            { letter: 'B', image: `${B9}/LISTENING%20PART%203/11%20(B).png`,     label: 'B' },
            { letter: 'C', image: `${B9}/LISTENING%20PART%203/C%20(EXAMPLE).png`, label: 'C (ejemplo)' },
            { letter: 'D', image: `${B9}/LISTENING%20PART%203/15%20(D).jpeg`,    label: 'D' },
            { letter: 'E', image: `${B9}/LISTENING%20PART%203/14%20(E).jpeg`,    label: 'E' },
            { letter: 'F', image: `${B9}/LISTENING%20PART%203/12%20(F).jpeg`,    label: 'F' },
          ],
          exampleAnswer: 'C',
          questions: [
            { num: 11, audioUrl: `${B9}/LISTENING%20PART%203/11.mp3`, audioText: '', answer: 'B' },
            { num: 12, audioUrl: `${B9}/LISTENING%20PART%203/12.mp3`, audioText: '', answer: 'F' },
            { num: 13, audioUrl: `${B9}/LISTENING%20PART%203/13.mp3`, audioText: '', answer: 'A' },
            { num: 14, audioUrl: `${B9}/LISTENING%20PART%203/14.mp3`, audioText: '', answer: 'E' },
            { num: 15, audioUrl: `${B9}/LISTENING%20PART%203/15.mp3`, audioText: '', answer: 'D' },
          ],
        },
        part4: {
          title: 'Parte 4 · Tres opciones',
          ...
          // Sim 9 L4 from .bmp option filenames:
          //   16: A fàndiàn lǐ (✓) / B xuéxiào lǐ / C chūzūchē shàng
          //   17: A ài xuéxí / B hěn gāoxìng / C hěn piàoliang (✓)
          //   18: A diànshì / B diànnǎo (✓) / C zhuōzi
          //   19: A xiǎo māo (✓) / B xiǎo gǒu / C yí gè rén
          //   20: A xīngqī'èr / B xīngqīwǔ / C xīngqīliù (✓)
          questions: [
            { num: 16, audioUrl: `${B9}/LISTENING%20PART%204/16/16.mp3`, audioText: '', options: [
                { letter: 'A', text: 'fàndiàn lǐ' },
                { letter: 'B', text: 'xuéxiào lǐ' },
                { letter: 'C', text: 'chūzūchē shàng' },
              ], answer: 'A' },
            { num: 17, audioUrl: `${B9}/LISTENING%20PART%204/17/17.mp3`, audioText: '', options: [
                { letter: 'A', text: 'ài xuéxí' },
                { letter: 'B', text: 'hěn gāoxìng' },
                { letter: 'C', text: 'hěn piàoliang' },
              ], answer: 'C' },
            { num: 18, audioUrl: `${B9}/LISTENING%20PART%204/18/18.mp3`, audioText: '', options: [
                { letter: 'A', text: 'diànshì' },
                { letter: 'B', text: 'diànnǎo' },
                { letter: 'C', text: 'zhuōzi' },
              ], answer: 'B' },
            { num: 19, audioUrl: `${B9}/LISTENING%20PART%204/19/19.mp3`, audioText: '', options: [
                { letter: 'A', text: 'xiǎo māo' },
                { letter: 'B', text: 'xiǎo gǒu' },
                { letter: 'C', text: 'yí gè rén' },
              ], answer: 'A' },
            { num: 20, audioUrl: `${B9}/LISTENING%20PART%204/20/20.mp3`, audioText: '', options: [
                { letter: 'A', text: "xīngqī'èr" },
                { letter: 'B', text: 'xīngqīwǔ' },
                { letter: 'C', text: 'xīngqīliù' },
              ], answer: 'C' },
          ],
        },
      },
      reading: {
        part1: {
          title: 'Parte 5 (Lectura 1) · Verdadero / Falso',
          instruction: 'Lee la palabra. ¿Coincide con la imagen? Marca ✓ o ✕.',
          example: { num: 'EJ', word: 'diànshì', image: `${B9}/READING%20PART%201/EXAMPLE%20(FALSE).png`, answer: false },
          // Sim 9 R1 words (QUESTIONS.txt) + markers T F F F T
          questions: [
            { num: 21, word: 'shuìjiào', image: `${B9}/READING%20PART%201/21%20(TRUE).jpeg`,  answer: true  },
            { num: 22, word: 'rè',       image: `${B9}/READING%20PART%201/22%20(FALSE).png`,  answer: false },
            { num: 23, word: 'xuéshēng', image: `${B9}/READING%20PART%201/23%20(FALSE).png`,  answer: false },
            { num: 24, word: 'bēizi',    image: `${B9}/READING%20PART%201/24%20(FALSE).png`,  answer: false },
            { num: 25, word: 'dú',       image: `${B9}/READING%20PART%201/25%20(TRUE).jpeg`,  answer: true  },
          ],
        },
        part2: {
          title: 'Parte 6 (Lectura 2) · Empareja con la imagen',
          instruction: 'Lee cada oración y toca la letra de la imagen que la representa.',
          // Sim 9 R2 picture-letter map: 26→C 27→F 28→A 29→D 30→B · E example
          gallery: [
            { letter: 'A', image: `${B9}/READING%20PART%202/28%20(A).png`,     label: 'A' },
            { letter: 'B', image: `${B9}/READING%20PART%202/30%20(B).png`,     label: 'B' },
            { letter: 'C', image: `${B9}/READING%20PART%202/26%20(C).png`,     label: 'C' },
            { letter: 'D', image: `${B9}/READING%20PART%202/29%20(D).jpeg`,    label: 'D' },
            { letter: 'E', image: `${B9}/READING%20PART%202/E%20(EXAMPLE).png`, label: 'E (ejemplo)' },
            { letter: 'F', image: `${B9}/READING%20PART%202/27%20(F).jpeg`,    label: 'F' },
          ],
          example: { num: 'EJ', hanzi: '我很喜欢这本书', pinyin: 'Wǒ hěn xǐhuān zhè běn shū', answer: 'E' },
          questions: [
            { num: 26, hanzi: '这些菜都是王小姐做的吗？',     pinyin: 'Zhèxiē cài dōu shì Wáng xiǎojiě zuò de ma?',  answer: 'C' },
            { num: 27, hanzi: '请多吃一点儿水果',           pinyin: 'Qǐng duō chī yìdiǎnr shuǐguǒ',               answer: 'F' },
            { num: 28, hanzi: '我爸爸是开飞机的',           pinyin: 'Wǒ bàba shì kāi fēijī de',                   answer: 'A' },
            { num: 29, hanzi: '对不起，我下午去商店买一个杯子', pinyin: 'Duìbuqǐ, wǒ xiàwǔ qù shāngdiàn mǎi yí gè bēizi', answer: 'D' },
            { num: 30, hanzi: '9点了，我想去看电视',         pinyin: '9 diǎn le, wǒ xiǎng qù kàn diànshì',         answer: 'B' },
          ],
        },
        part3: {
          title: 'Parte 7 (Lectura 3) · Pregunta ↔ Respuesta',
          instruction: 'Lee cada pregunta y elige la mejor respuesta del banco A-F.',
          bank: [
            { letter: 'A', hanzi: '不是',   pinyin: 'bùshì' },
            { letter: 'B', hanzi: '没有',   pinyin: 'méiyǒu' },
            { letter: 'C', hanzi: '我同学', pinyin: 'wǒ tóngxué' },
            { letter: 'D', hanzi: '10岁',   pinyin: '10 suì' },
            { letter: 'E', hanzi: '明天',   pinyin: 'míngtiān' },
            { letter: 'F', hanzi: '好的，谢谢！', pinyin: 'hǎo de, xièxie!' },
          ],
          example: { num: 'EJ', hanzi: '你喝水吗？', pinyin: 'Nǐ hē shuǐ ma?', answer: 'F' },
          questions: [
            { num: 31, hanzi: '前面那个人是谁？',       pinyin: 'Qiánmiàn nàge rén shì shéi?',        answer: 'C', es: '¿Quién es esa persona de adelante? → (mi compañero)', en: 'Who is that person up front? → (my classmate)' },
            { num: 32, hanzi: '你昨天上午去学校了吗？', pinyin: 'Nǐ zuótiān shàngwǔ qù xuéxiào le ma?', answer: 'B', es: '¿Fuiste a la escuela ayer en la mañana? → (no)', en: 'Did you go to school yesterday morning? → (no)' },
            { num: 33, hanzi: '这个电影是60分钟吗？',   pinyin: 'Zhège diànyǐng shì 60 fēnzhōng ma?',  answer: 'A', es: '¿Esta película dura 60 minutos? → (no)', en: 'Is this movie 60 minutes long? → (no)' },
            { num: 34, hanzi: '你儿子今年多大？',       pinyin: 'Nǐ érzi jīnnián duō dà?',             answer: 'D', es: '¿Cuántos años tiene tu hijo? → (10 años)', en: 'How old is your son this year? → (10 years old)' },
            { num: 35, hanzi: '你哪天回国？',           pinyin: 'Nǐ nǎ tiān huí guó?',                 answer: 'E', es: '¿Qué día regresas a tu país? → (mañana)', en: 'What day do you go back to your country? → (tomorrow)' },
          ],
        },
        part4: {
          title: 'Parte 8 (Lectura 4) · Completa la oración',
          ...
          bank: [
            { letter: 'A', hanzi: '太',   pinyin: 'tài' },
            { letter: 'B', hanzi: '工作', pinyin: 'gōngzuò' },
            { letter: 'C', hanzi: '本',   pinyin: 'běn' },
            { letter: 'D', hanzi: '名字', pinyin: 'míngzi' },
            { letter: 'E', hanzi: '喜欢', pinyin: 'xǐhuān' },
            { letter: 'F', hanzi: '能',   pinyin: 'néng' },
          ],
          example: { num: 'EJ', hanzi: '你叫什么 ( )？', pinyin: 'Nǐ jiào shénme ( )?', answer: 'D' },
          questions: [
            { num: 36, hanzi: '她的衣服（ ）小了',                 pinyin: 'Tā de yīfú ( ) xiǎo le',                       answer: 'A', es: 'Su ropa es (demasiado) pequeña.', en: 'Her clothes are (too) small.' },
            { num: 37, hanzi: '昨天我买了一（ ）汉语书',           pinyin: 'Zuótiān wǒ mǎi le yī ( ) hànyǔ shū',           answer: 'C', es: 'Ayer compré un (libro) de chino.', en: 'Yesterday I bought a Chinese (book).' },
            { num: 38, hanzi: '我在北京住了5年，我很（ ）这里',     pinyin: 'Wǒ zài Běijīng zhù le 5 nián, wǒ hěn ( ) zhèlǐ', answer: 'E', es: 'Viví 5 años en Pekín; me (gusta) mucho este lugar.', en: 'I lived in Beijing for 5 years; I really (like) this place.' },
            { num: 39, hanzi: '妈妈这个月（ ）回来',               pinyin: 'Māmā zhège yuè ( ) huílái',                    answer: 'F', es: 'Mamá (puede) volver este mes.', en: 'Mom (can) come back this month.' },
            { num: 40, hanzi: '你好，你是做什么（ ）的？',         pinyin: 'Nǐ hǎo, nǐ shì zuò shénme ( ) de?',            answer: 'B', es: 'Hola, ¿en qué (trabajas)?', en: 'Hello, what (work) do you do?' },
          ],
        },
      },
    };
  ...
  // ═══════════════════════════════════════════════════════════════════════
  // HSK1 · SIMULATION 10 — tenth mock exam, full 40 questions.
  // Assets uploaded by user 2026-07-05 in
  // /assets/HSK SIMULATIONS/HSK 1/SIMULATION 10/.
  // Answer keys from filename markers: L1 T F F T T · L2 C B B A B ·
  ...
  // ═══════════════════════════════════════════════════════════════════════
  'hsk1-sim10': (() => {
    const B10 = '/assets/HSK%20SIMULATIONS/HSK%201/SIMULATION%2010';
    return {
      id: 'hsk1-sim10',
      title: 'HSK1 · Simulación 10',
      level: 'hsk1',
      totalQuestions: 40,
      pointsPerQuestion: 10,
      listening: {
        part1: {
          ...
          instruction: 'Escucha el audio. ¿Es lo que muestra la imagen? Marca ✓ o ✕.',
          examples: [
            { num: 'EJ1', image: `${B10}/LISTENING%20PART%201/PART%201%20EXAMPLE%201.png`, audioText: '', answer: true,  caption: 'Ejemplo 1' },
            { num: 'EJ2', image: `${B10}/LISTENING%20PART%201/PART%201%20EXAMPLE%202.png`, audioText: '', answer: false, caption: 'Ejemplo 2' },
          ],
          // Sim 10 L1 markers: T F F T T
          questions: [
            { num: 1, image: `${B10}/LISTENING%20PART%201/1%20(TRUE).png`,  audioUrl: `${B10}/LISTENING%20PART%201/1.mp3`, audioText: '', answer: true  },
            { num: 2, image: `${B10}/LISTENING%20PART%201/2%20(FALSE).png`, audioUrl: `${B10}/LISTENING%20PART%201/2.mp3`, audioText: '', answer: false },
            { num: 3, image: `${B10}/LISTENING%20PART%201/3%20(FALSE).png`, audioUrl: `${B10}/LISTENING%20PART%201/3.mp3`, audioText: '', answer: false },
            { num: 4, image: `${B10}/LISTENING%20PART%201/4%20(TRUE).png`,  audioUrl: `${B10}/LISTENING%20PART%201/4.mp3`, audioText: '', answer: true  },
            { num: 5, image: `${B10}/LISTENING%20PART%201/5%20(TRUE).png`,  audioUrl: `${B10}/LISTENING%20PART%201/5.mp3`, audioText: '', answer: true  },
          ],
        },
        part2: {
          title: 'Parte 2 · Tres imágenes',
          ...
          questions: [
            { num: 6,  audioUrl: `${B10}/LISTENING%20PART%202/6.mp3`,  audioText: '', options: [
                ...
                { letter: 'B', image: `${B10}/LISTENING%20PART%202/6B.png` },
                { letter: 'C', image: `${B10}/LISTENING%20PART%202/6C%20(TRUE).png` },
              ], answer: 'C' },
            { num: 7,  audioUrl: `${B10}/LISTENING%20PART%202/7.mp3`,  audioText: '', options: [
                { letter: 'A', image: `${B10}/LISTENING%20PART%202/7A.png` },
                { letter: 'B', image: `${B10}/LISTENING%20PART%202/7B%20(CORRECT).png` },
                { letter: 'C', image: `${B10}/LISTENING%20PART%202/7C.png` },
              ], answer: 'B' },
            { num: 8,  audioUrl: `${B10}/LISTENING%20PART%202/8.mp3`,  audioText: '', options: [
                { letter: 'A', image: `${B10}/LISTENING%20PART%202/8A.png` },
                { letter: 'B', image: `${B10}/LISTENING%20PART%202/8B%20(CORRECT).png` },
                { letter: 'C', image: `${B10}/LISTENING%20PART%202/8C.png` },
              ], answer: 'B' },
            ...
            { num: 10, audioUrl: `${B10}/LISTENING%20PART%202/10.mp3`, audioText: '', options: [
                { letter: 'A', image: `${B10}/LISTENING%20PART%202/10A.png` },
                { letter: 'B', image: `${B10}/LISTENING%20PART%202/10B%20(CORRECT).png` },
                { letter: 'C', image: `${B10}/LISTENING%20PART%202/10C.png` },
              ], answer: 'B' },
          ],
        },
        part3: {
          title: 'Parte 3 · Empareja con la imagen',
          instruction: 'Escucha cada audio y toca la letra de la imagen correcta.',
          // Sim 10 "N (LETTER)": 11→B 12→E 13→D 14→A 15→F · C example
          gallery: [
            { letter: 'A', image: `${B10}/LISTENING%20PART%203/14%20(A).png`,     label: 'A' },
            { letter: 'B', image: `${B10}/LISTENING%20PART%203/11%20(B).png`,     label: 'B' },
            { letter: 'C', image: `${B10}/LISTENING%20PART%203/C%20(EXAMPLE).png`, label: 'C (ejemplo)' },
            { letter: 'D', image: `${B10}/LISTENING%20PART%203/13%20(D).png`,     label: 'D' },
            { letter: 'E', image: `${B10}/LISTENING%20PART%203/12%20(E).png`,     label: 'E' },
            { letter: 'F', image: `${B10}/LISTENING%20PART%203/15%20(F).jpeg`,    label: 'F' },
          ],
          exampleAnswer: 'C',
          questions: [
            { num: 11, audioUrl: `${B10}/LISTENING%20PART%203/11.mp3`, audioText: '', answer: 'B' },
            { num: 12, audioUrl: `${B10}/LISTENING%20PART%203/12.mp3`, audioText: '', answer: 'E' },
            { num: 13, audioUrl: `${B10}/LISTENING%20PART%203/13.mp3`, audioText: '', answer: 'D' },
            { num: 14, audioUrl: `${B10}/LISTENING%20PART%203/14.mp3`, audioText: '', answer: 'A' },
            { num: 15, audioUrl: `${B10}/LISTENING%20PART%203/15.mp3`, audioText: '', answer: 'F' },
          ],
        },
        part4: {
          title: 'Parte 4 · Tres opciones',
          ...
          // Sim 10 L4 from .bmp option filenames:
          //   16: A kāi chē / B zuò fēijī (✓) / C zuò chūzūchē
          //   17: A 70 / B 80 (✓) / C 90
          //   18: A fàndiàn (✓) / B shāngdiàn / C xuéxiào
          //   19: A kàn diànshì / B kàn yīshēng / C dǎ diànhuà (✓)
          //   20: A hěn hǎo / B hěn lěng (✓) / C hěn rè
          questions: [
            { num: 16, audioUrl: `${B10}/LISTENING%20PART%204/16/16.mp3`, audioText: '', options: [
                { letter: 'A', text: 'kāi chē' },
                { letter: 'B', text: 'zuò fēijī' },
                { letter: 'C', text: 'zuò chūzūchē' },
              ], answer: 'B' },
            { num: 17, audioUrl: `${B10}/LISTENING%20PART%204/17/17.mp3`, audioText: '', options: [
                { letter: 'A', text: '70' },
                { letter: 'B', text: '80' },
                { letter: 'C', text: '90' },
              ], answer: 'B' },
            { num: 18, audioUrl: `${B10}/LISTENING%20PART%204/18/18.mp3`, audioText: '', options: [
                { letter: 'A', text: 'fàndiàn' },
                { letter: 'B', text: 'shāngdiàn' },
                { letter: 'C', text: 'xuéxiào' },
              ], answer: 'A' },
            { num: 19, audioUrl: `${B10}/LISTENING%20PART%204/19/19.mp3`, audioText: '', options: [
                { letter: 'A', text: 'kàn diànshì' },
                { letter: 'B', text: 'kàn yīshēng' },
                { letter: 'C', text: 'dǎ diànhuà' },
              ], answer: 'C' },
            { num: 20, audioUrl: `${B10}/LISTENING%20PART%204/20/20.mp3`, audioText: '', options: [
                { letter: 'A', text: 'hěn hǎo' },
                { letter: 'B', text: 'hěn lěng' },
                { letter: 'C', text: 'hěn rè' },
              ], answer: 'B' },
          ],
        },
      },
      reading: {
        part1: {
          title: 'Parte 5 (Lectura 1) · Verdadero / Falso',
          instruction: 'Lee la palabra. ¿Coincide con la imagen? Marca ✓ o ✕.',
          example: { num: 'EJ', word: 'diànshì', image: `${B10}/READING%20PART%201/EXAMPLE%20(FALSE).png`, answer: false },
          // Sim 10 R1 words (QUESTIONS.txt) + markers F T F T T
          questions: [
            { num: 21, word: 'yīyuàn', image: `${B10}/READING%20PART%201/21%20(FALSE).png`, answer: false },
            { num: 22, word: 'mǐfàn',  image: `${B10}/READING%20PART%201/22%20(TRUE).png`,  answer: true  },
            { num: 23, word: 'bēizi',  image: `${B10}/READING%20PART%201/23%20(FALSE).png`, answer: false },
            { num: 24, word: 'xuéxí',  image: `${B10}/READING%20PART%201/24%20(TRUE).png`,  answer: true  },
            { num: 25, word: 'gǒu',    image: `${B10}/READING%20PART%201/25%20(TRUE).png`,  answer: true  },
          ],
        },
        part2: {
          title: 'Parte 6 (Lectura 2) · Empareja con la imagen',
          instruction: 'Lee cada oración y toca la letra de la imagen que la representa.',
          // Sim 10 R2 picture-letter map: 26→D 27→A 28→C 29→F 30→B · E example
          // Files 28/29/30 use fullwidth （） in the name — encoded below.
          gallery: [
            { letter: 'A', image: `${B10}/READING%20PART%202/27%20(A).png`,                    label: 'A' },
            { letter: 'B', image: `${B10}/READING%20PART%202/30%20%EF%BC%88B%EF%BC%89.png`,    label: 'B' },
            { letter: 'C', image: `${B10}/READING%20PART%202/28%20%EF%BC%88C%EF%BC%89.png`,    label: 'C' },
            { letter: 'D', image: `${B10}/READING%20PART%202/26%20(D).png`,                    label: 'D' },
            { letter: 'E', image: `${B10}/READING%20PART%202/E%20(EXAMPLE).png`,               label: 'E (ejemplo)' },
            { letter: 'F', image: `${B10}/READING%20PART%202/29%20%EF%BC%88F%EF%BC%89.png`,    label: 'F' },
          ],
          example: { num: 'EJ', hanzi: '我很喜欢这本书', pinyin: 'Wǒ hěn xǐhuān zhè běn shū', answer: 'E' },
          questions: [
            { num: 26, hanzi: '他的工作太多了。',             pinyin: 'Tā de gōngzuò tài duō le',                 answer: 'D' },
            { num: 27, hanzi: '请在这里写你的名字。',         pinyin: 'Qǐng zài zhèlǐ xiě nǐ de míngzi',          answer: 'A' },
            { num: 28, hanzi: '电脑在桌子上。',               pinyin: 'Diànnǎo zài zhuōzi shàng',                 answer: 'C' },
            { num: 29, hanzi: '我看不见了。',                 pinyin: 'Wǒ kàn bú jiàn le',                        answer: 'F' },
            { num: 30, hanzi: '妈妈做了三个菜，你喜欢哪个？', pinyin: 'Māma zuò le sān gè cài, nǐ xǐhuān nǎge?',  answer: 'B' },
          ],
        },
        part3: {
          title: 'Parte 7 (Lectura 3) · Pregunta ↔ Respuesta',
          instruction: 'Lee cada pregunta y elige la mejor respuesta del banco A-F.',
          bank: [
            { letter: 'A', hanzi: '去饭店了',     pinyin: 'qù fàndiàn le' },
            { letter: 'B', hanzi: '是的',         pinyin: 'shì de' },
            { letter: 'C', hanzi: '我同学',       pinyin: 'wǒ tóngxué' },
            { letter: 'D', hanzi: '2月1号',       pinyin: '2 yuè 1 hào' },
            { letter: 'E', hanzi: '4岁',          pinyin: '4 suì' },
            { letter: 'F', hanzi: '好的，谢谢！', pinyin: 'hǎo de, xièxie!' },
          ],
          example: { num: 'EJ', hanzi: '你喝水吗？', pinyin: 'Nǐ hē shuǐ ma?', answer: 'F' },
          questions: [
            { num: 31, hanzi: '你中午怎么没回家呢？', pinyin: 'Nǐ zhōngwǔ zěnme méi huí jiā ne?', answer: 'A', es: '¿Por qué no volviste a casa al mediodía? → (fui al restaurante)', en: 'Why did you not go home at noon? → (I went to the restaurant)' },
            { num: 32, hanzi: '小王哪天去学车？',     pinyin: 'Xiǎo Wáng nǎ tiān qù xué chē?',    answer: 'D', es: '¿Qué día va Xiao Wang a aprender a manejar? → (el 1 de febrero)', en: 'What day is Xiao Wang going to learn to drive? → (February 1st)' },
            { num: 33, hanzi: '前面那几个人是谁？',   pinyin: 'Qiánmiàn nà jǐ gè rén shì shéi?',  answer: 'C', es: '¿Quiénes son esas personas de adelante? → (mis compañeros)', en: 'Who are those people up front? → (my classmates)' },
            { num: 34, hanzi: '小月会说汉语？',       pinyin: 'Xiǎo Yuè huì shuō Hànyǔ?',         answer: 'B', es: '¿Xiao Yue sabe hablar chino? → (sí)', en: 'Can Xiao Yue speak Chinese? → (yes)' },
            { num: 35, hanzi: '你的儿子多大？',       pinyin: 'Nǐ de érzi duō dà?',               answer: 'E', es: '¿Cuántos años tiene tu hijo? → (4 años)', en: 'How old is your son? → (4 years old)' },
          ],
        },
        part4: {
          title: 'Parte 8 (Lectura 4) · Completa el espacio',
          instruction: 'Lee cada oración y elige la palabra del banco que completa el espacio ( ).',
          bank: [
            { letter: 'A', hanzi: '对不起', pinyin: 'duìbuqǐ' },
            { letter: 'B', hanzi: '高兴',   pinyin: 'gāoxìng' },
            { letter: 'C', hanzi: '住',     pinyin: 'zhù' },
            { letter: 'D', hanzi: '名字',   pinyin: 'míngzi' },
            { letter: 'E', hanzi: '时候',   pinyin: 'shíhou' },
            { letter: 'F', hanzi: '少',     pinyin: 'shǎo' },
          ],
          example: { num: 'EJ', hanzi: '你叫什么（ ）？', pinyin: 'Nǐ jiào shénme ( )?', answer: 'D' },
          questions: [
            { num: 36, hanzi: '你来看我，我很（ ）。',               pinyin: 'Nǐ lái kàn wǒ, wǒ hěn ( )',                       answer: 'B', es: 'Viniste a verme; estoy muy (feliz).', en: 'You came to see me; I am very (happy).' },
            { num: 37, hanzi: '（ ），你说什么？我没听见。',         pinyin: '( ), nǐ shuō shénme? Wǒ méi tīngjiàn',            answer: 'A', es: '(Perdón), ¿qué dijiste? No te oí.', en: '(Sorry), what did you say? I did not hear you.' },
            { num: 38, hanzi: '我不喜欢这个书店，书太（ ）了。',     pinyin: 'Wǒ bù xǐhuān zhège shūdiàn, shū tài ( ) le',      answer: 'F', es: 'No me gusta esta librería; tiene muy (pocos) libros.', en: 'I do not like this bookstore; it has too (few) books.' },
            { num: 39, hanzi: '你什么（ ）回中国？明年，你呢？',     pinyin: 'Nǐ shénme ( ) huí Zhōngguó? Míngnián, nǐ ne?',    answer: 'E', es: '¿(Cuándo) vuelves a China? — El próximo año, ¿y tú?', en: '(When) are you going back to China? — Next year, and you?' },
            { num: 40, hanzi: '他在哪儿（ ）？在北京大学后面。',     pinyin: "Tā zài nǎ'er ( )? Zài Běijīng dàxué hòumiàn",     answer: 'C', es: '¿Dónde (vive) él? — Detrás de la Universidad de Pekín.', en: 'Where does he (live)? — Behind Peking University.' },
          ],
        },
      },
    };
...
function buildSimPayload(simId) {
  ...
  const sanitizeOpt = (q) => {
    ...
    delete cp.answer;
    // 🔒 es/en meanings (2026-07-07) are TEACHER-only: the translation
    // strings literally contain the correct answer ("→ (es muy pequeña)"),
    // so they must never reach the kid exam payload. The practice mode
    // reads SIMULATIONS directly through the admin-gated endpoint.
    delete cp.es;
    delete cp.en;
    return cp;
  };
